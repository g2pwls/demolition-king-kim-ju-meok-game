...
function EventPage() {
  ...
  const worldpinData = [
    ...
    { id: 2, name: '요르단', top: '-60px', left: '53.2%' },
    { id: 3, name: '뉴욕', top: '-90px', left: '32.6%' },
    { id: 4, name: '캄보디아', top: '-12px', left: '65.2%' },
    { id: 5, name: '페루', top: '60px', left: '33.2%' },
    { id: 6, name: '시드니', top: '120px', left: '73.5%' },
    { id: 7, name: '이집트', top: '-42px', left: '52%' },
    { id: 8, name: '한국', top: '-85px', left: '69.6%' },
    { id: 9, name: '일본', top: '-72px', left: '71.5%' },
    { id: 10, name: '파리', top: '-112px', left: '47%' },
    { id: 11, name: '런던', top: '-150px', left: '47%' },
    { id: 12, name: '미국', top: '-100px', left: '27%' },
    { id: 13, name: '인도', top: '-50px', left: '61%' },
    { id: 14, name: '이탈리아', top: '-110px', left: '50%' },
  ];
